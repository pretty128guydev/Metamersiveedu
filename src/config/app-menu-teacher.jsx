const Menu = [
  ...
  },
  {
    ...
    children: [
      ...
      // { path: "/analytics/word-dash", title: "Word Dash" },
      // { path: "/analytics/tag-game", title: "Tag Game" },
    ],
  },
  ...
  //   title: "Question Bank",
  //   children: [
  //     { path: "/QB/subjects", title: "My Bank" },
  //     // { path: "/QB/sharedSubjects", title: "Shared" },
  //   ],
  // },
  // {
  //   path: "/upload-data",
  ...
  //   children: [
  //     {
  //       path: "/upload-data/listening-a",
  //       title: "Listening A",
  //     },
  //     {
  //       path: "/upload-data/listening-b",
  //       title: "Listening B",
  //     },
  //     {
  //       path: "/upload-data/speaking",
  //       title: "Speaking",
  //     },
  //     {
  //       path: "/upload-data/reading",
  //       title: "Reading",
  //     },
  //     {
  //       path: "upload-data/writing",
  //       title: "Writing",
  //     },
  //   ],
  // },
