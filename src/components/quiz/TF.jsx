...
function TrueFalseQuiz(props) {
  ...
  const [answer, setAnswer] = useState(data.answer === "true" ? true : false);
    ...
    <Card className={"mb-3" + (selected ? " selected" : "")}>
      <form className="was-validated" onSubmit={handleSave}>
        <CardHeader className="d-flex justify-content-between align-items-center">
          <span className="me-2 fa-lg">{index + 1}. {translate("true-false")}</span>
          <div>
            {loading ? (
              <BarsScale />
            ) : (
        ...
        <CardBody>
          ...
          >
            ...
            <div className="form-check form-switch mb-3">
              <input
                ...
                id={`trueFalseSwitch${index}`}
                checked={answer}
                onChange={(e) => setAnswer(e.target.checked)}
              />
              <label
                className="form-check-label"
                htmlFor={`trueFalseSwitch${index}`}
              >
                {answer ? "True" : "False"}
              </label>
            </div>
          ...
          >
            ...
            <div className="mb-3">{answer ? "True" : "False"}</div>
