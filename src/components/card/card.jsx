...
function Card(props) {
	return (
		<div className={'card bg-default '+ (props.className ? props.className : '')} style={props.style}>
			{ props.children }
...
function CardExpandToggler(props) {
	...
	return (
		<a href="#/" onClick={toggleCardExpand} ref={tooltipRef} className="text-primary text-opacity-50 text-decoration-none"><i className="bi bi-fullscreen"></i></a>
	);
}
