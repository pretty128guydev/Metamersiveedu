    ...
    <div>
      ...
      {loading ? (
        ...
        <>
          ...
          <YTD_Growth studentPage={userInfo.type == "Student" && teacher_id} selectedClass={selectedClass} selectedCategory={selectedCategory} selectedStudent={selectedStudentName} teacher_id={teacher_id} />
          <Progress_Report studentPage={userInfo.type == "Student" && teacher_id} selectedClass={selectedClass} selectedCategory={selectedCategory} selectedStudent={selectedStudentName} teacher_id={teacher_id} />
          <TopStudentPerformance studentPage={userInfo.type == "Student" && teacher_id} selectedClass={selectedClass} selectedCategory={selectedCategory} selectedStudent={selectedStudent} teacher_id={teacher_id} />
          {userInfo.type != "Student" &&
            <TopScoringStudents selectedClass={selectedClass} selectedCategory={selectedCategory} selectedStudent={selectedStudentName} teacher_id={teacher_id} />
          }
          {userInfo.type != "Student" &&
            <NegativeProgress teacher_id={teacher_id} />
          }
          {userInfo.type != "Student" &&
            <TroubleZone />
          }
...
export default ProgressForAdmin;
