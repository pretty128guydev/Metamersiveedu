      ...
      <>
        ...
        {loading ? (
          ...
          <>
            ...
            <div className="mt-4">
              <UsageActivity studentPage={userInfo.type == "Student" && teacher_id} selectedClass={selectedClass} selectedStudent={selectedStudent} teacher_id={teacher_id} />
            </div>
            <div className="mt-4">
              <PerformanceIndex studentPage={userInfo.type == "Student" && teacher_id} selectedClass={selectedClass} selectedStudent={selectedStudentName} teacher_id={teacher_id} />
            </div>
            <div className="mt-4">
              <QuestionsChart studentPage={userInfo.type == "Student" && teacher_id} selectedClass={selectedClass} selectedStudent={selectedStudent} teacher_id={teacher_id} />
            </div>
          </>
        )}
      </>
...
export default StudentsForAdmin;
