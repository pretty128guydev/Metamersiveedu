...
const TeacherManagementForAdmin = () => {
  ...
  useEffect(() => {
    ...
    AdminAPI.getTeacherBySchoolId({ schoolId: school_id })
      .then(async (data) => {
    ...
    AdminAPI.getStudent({ schoolId: school_id })
      .then((data) => {
                ...
                <div className="pos-sidebar" id="pos-sidebar">
                  ...
                  <PerfectScrollbar className="pos-sidebar-body">
                    <div className="d-flex justify-content-between w-100">
                      <h5 className="pos-order py-3 my-0">School Id: </h5>
                      <h5 className="mx-3 py-3 my-0">{school_id}</h5>
                    </div>
                    <div className="d-flex justify-content-between w-100">
                    ...
                    <div className="h-100">
                      ...
                      >
                        <span className="text-decoration-underline mr-1">
                          ...
                          {selectedTable?.classrooms?.tagClassrooms?.ret
                            .length >= 2
                            ? "Classes"
                            : "Class"}
                        </span>
                      ...
                      >
                        <span className="text-decoration-underline mr-1">
                          Word Dash:{" "}
                          {
                            selectedTable?.classrooms?.wordClassrooms?.ret
                              .length
                          }{" "}
                          {selectedTable?.classrooms?.wordClassrooms?.ret
                            .length >= 2
                      ...
                      >
                        <span className="text-decoration-underline mr-1">
                          Village:{" "}
                          {
                            selectedTable?.classrooms?.villageClassrooms?.ret
                              .length
                          }{" "}
                          {selectedTable?.classrooms?.villageClassrooms?.ret
                            .length >= 2
...
export default TeacherManagementForAdmin;
