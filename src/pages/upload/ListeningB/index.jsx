...
export default function ListeningA() {
  const [level, setLevel] = useState(1);

  return (
    <div className='upload'>
      <div className='d-flex justify-content-between'>
        <h1 className="page-header mb-0">Listening B</h1>
        <Link type='button' className='btn btn-outline-primary align-self-end' to={'/upload-data/listening-b/create'}>
