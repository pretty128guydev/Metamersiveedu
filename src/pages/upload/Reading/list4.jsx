        ...
        <table className="table table-striped mt-3">
          <thead className="table-dark">
            <tr>
              ...
              <th scope='col'>Paragraph Number</th>
              <th scope='col'>Text</th>
              <th scope='col'>Question</th>
              <th scope='col'>Answer</th>
              <th scope='col'>Hint1</th>
              <th scope='col'>Hint2</th>
              <th scope='col'></th>
              <th scope='col'></th>
            </tr>
          </thead>
          <tbody>
            {
              data && data.map((val, idx) => (
                <tr key={val.id}>
                  ...
                  <td>{val.test_info}</td>
                  <td>{val.pn}</td>
                  <td dangerouslySetInnerHTML={{ __html: val.text }}></td>
                  <td dangerouslySetInnerHTML={{ __html: val.question }}></td>
                  <td dangerouslySetInnerHTML={{ __html: val.answer }}></td>
                  <td dangerouslySetInnerHTML={{ __html: val.hint1 }}></td>
                  <td dangerouslySetInnerHTML={{ __html: val.hint2 }}></td>
                  <td>
                    <Link to={'/upload-data/reading/update?level=4&id='+val.id}>
