        ...
        <table className="table table-striped mt-3">
          <thead className="table-dark">
            <tr>
              ...
              <th scope='col'>Helpful Vocabulary Words/considerations</th>
              <th scope='col'></th>
              <th scope='col'></th>
            </tr>
          </thead>
          <tbody>
            {
              data && data.map((val, idx) => (
                <tr key={val.id}>
                  ...
                  <td>
                    <Link to={'/upload-data/speaking/update?level=4&id='+val.id}>
