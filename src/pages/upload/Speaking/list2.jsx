        ...
        <table className="table table-striped mt-3">
          <thead className="table-dark">
            <tr>
              ...
              <th scope='col'>Pros / Subject</th>
              <th scope='col'>Cons / Subject</th>
              <th scope='col'></th>
              <th scope='col'></th>
            </tr>
          </thead>
          <tbody>
            {
              data && data.map((val, idx) => (
                <tr key={val.id}>
                  ...
                  <td>{val.id}</td>
                  <td dangerouslySetInnerHTML={{ __html: val.topic }}></td>
                  <td dangerouslySetInnerHTML={{ __html: val.pros }}></td>
                  <td dangerouslySetInnerHTML={{ __html: val.cons }}></td>
                  <td>
                    <Link to={'/upload-data/speaking/update?level=2&id='+val.id}>
