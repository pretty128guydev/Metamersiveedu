          ...
          <tbody>
            {
              data && data.map((val, idx) => (
                <tr key={val.id}>
                  ...
                  <td>{val.prompt}</td>
                  <td dangerouslySetInnerHTML={{ __html: val.introduction }}></td>
                  <td dangerouslySetInnerHTML={{ __html: val.idea1 }}></td>
                  <td dangerouslySetInnerHTML={{ __html: val.idea2 }}></td>
                  <td dangerouslySetInnerHTML={{ __html: val.idea3 }}></td>
                  <td dangerouslySetInnerHTML={{ __html: val.conclusion }}></td>
                  <td>
                    <Link to={'/upload-data/speaking/update?level=3&id='+val.id}>
