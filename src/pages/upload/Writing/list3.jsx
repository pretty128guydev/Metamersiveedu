          ...
          <tbody>
            {
              data && data.map((val, idx) => (
                <tr key={val.id}>
                  ...
                  <td dangerouslySetInnerHTML={{ __html: val.jumbled_text }}></td>
                  <td>
                    <Link to={'/upload-data/writing/update?level=3&id='+val.id}>
