        ...
        <table className="table table-striped mt-3">
          <thead className="table-dark">
            <tr>
              ...
              <th scope='col'>Link to Picture</th>
              <th scope='col'>Hint/Keywords</th>
              <th scope='col'></th>
              <th scope='col'></th>
            </tr>
          </thead>
          <tbody>
            {
              data && data.map((val, idx) => (
                <tr key={val.id}>
                  ...
                  <td><a href={val.picture_link} target='blank'>{val.picture_name}</a></td>
                  <td>
                    {
                  ...
                  <td>
                    <Link to={'/upload-data/writing/update?level=1&id='+val.id}>
